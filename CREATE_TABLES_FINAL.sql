-- ==============================================
-- CREA TABELLE CON STRUTTURA CORRETTA
-- ==============================================

-- 1. Crea tabella sample_requests
...
-- 2. Crea tabella sample_request_items
...
-- 4. Crea tabella price_list_items
...
AND EXISTS (SELECT 1 FROM public.customers WHERE is_active = true);
...
BEGIN
    ...
    RAISE NOTICE '- sample_requests (con FK a customers.id)';
    RAISE NOTICE '- sample_request_items';
    RAISE NOTICE '- price_lists (con FK a customers.id)';
    RAISE NOTICE '- price_list_items';
    RAISE NOTICE '- orders (con FK a customers.id)';
