-- Fix ruolo utente production per etichette@farmap.it
-- Eseguire questo script in Supabase SQL Editor

-- 1) Verifica l'utente attuale
SELECT 
  u.id,
  u.email,
